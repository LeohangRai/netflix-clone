...
export default function SubscriptionPlanCard() {
  return (
    <div className="h-[350px] w-full border rounded p-3 pointer mr-3">
      <div className="w-full p-3 text-white font-bold rounded bg-gradient-to-r from-cyan-500 to-blue-500">
      ...
      <div className="border-b py-4 flex text-reg items-center">
        ...
        <div className="ml-3">
          <h3 className="text-gray-500">Monthly price</h3>
      ...
      <div className="border-b py-4 flex text-reg items-center">
        ...
        <div className="ml-3">
          <h3 className="text-gray-500">Rick & Morty</h3>
          <h3 className="font-semibold">Included</h3>
        </div>
      </div>
    </div>
